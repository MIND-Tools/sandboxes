 ...
 * $Id$
 */
package mindide.impl;

import java.util.Collection;

import mindide.MindAdl;
import mindide.MindFile;
import mindide.MindItf;
import mindide.MindPathEntry;
import mindide.MindProject;
import mindide.MindRepo;
import mindide.MindRootSrc;
 ...
 * <ul>
 *   <li>{@link mindide.impl.MindProjectImpl#getRootsrcs <em>Rootsrcs</em>}</li>
 *   <li>{@link mindide.impl.MindProjectImpl#getRepo <em>Repo</em>}</li>
 *   <li>{@link mindide.impl.MindProjectImpl#getUses <em>Uses</em>}</li>
 *   <li>{@link mindide.impl.MindProjectImpl#getMindpathentries <em>Mindpathentries</em>}</li>
 *   <li>{@link mindide.impl.MindProjectImpl#getProject <em>Project</em>}</li>
 *   <li>{@link mindide.impl.MindProjectImpl#getAllsrc <em>Allsrc</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
