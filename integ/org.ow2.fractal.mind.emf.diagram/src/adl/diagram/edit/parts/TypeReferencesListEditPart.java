...
import adl.diagram.edit.policies.TypeReferencesListItemSemanticEditPolicy;
 ...
 * @generated
 */
public class TypeReferencesListEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public TypeReferencesListEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new TypeReferencesListItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof TypeReferencesListCompartmentReferencesListAreaEditPart) {
			IFigure pane = getPrimaryShape().getFigureReferencesArea();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.add(((TypeReferencesListCompartmentReferencesListAreaEditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof TypeReferencesListCompartmentReferencesListAreaEditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.remove(((TypeReferencesListCompartmentReferencesListAreaEditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof TypeReferencesListCompartmentReferencesListAreaEditPart) {
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == MindElementTypes.TypeReferenceDefinition_3038) {
