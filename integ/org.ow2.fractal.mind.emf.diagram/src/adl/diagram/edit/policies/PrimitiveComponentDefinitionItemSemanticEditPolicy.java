...
import adl.diagram.edit.commands.PrimitiveReferencesListCreateCommand;
 ...
 * @generated
 */
public class PrimitiveComponentDefinitionItemSemanticEditPolicy extends
		MindBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public PrimitiveComponentDefinitionItemSemanticEditPolicy() {
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (MindElementTypes.FormalArgumentsList_3015 == req.getElementType()) {
			return getGEFWrapper(new FormalArgumentsList2CreateCommand(req));
		}
		...
		if (MindElementTypes.PrimitiveReferencesList_3035 == req
				.getElementType()) {
			return getGEFWrapper(new PrimitiveReferencesListCreateCommand(req));
		}
