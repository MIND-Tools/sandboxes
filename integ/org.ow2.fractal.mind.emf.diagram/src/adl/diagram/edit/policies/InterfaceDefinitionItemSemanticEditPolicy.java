 ...
 * @generated
 */
public class InterfaceDefinitionItemSemanticEditPolicy extends
		MindBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public InterfaceDefinitionItemSemanticEditPolicy() {
		super(MindElementTypes.InterfaceDefinition_3009);
	}
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (MindElementTypes.BindingDefinition_4001 == req.getElementType()) {
			return getGEFWrapper(new BindingDefinitionCreateCommand(req, req
	...
	protected Command getReorientRelationshipCommand(
		...
		case BindingDefinitionEditPart.VISUAL_ID:
			return getGEFWrapper(new BindingDefinitionReorientCommand(req));
		}
