 ...
 * @generated
 */
public abstract class MindAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = MindDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected MindAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
