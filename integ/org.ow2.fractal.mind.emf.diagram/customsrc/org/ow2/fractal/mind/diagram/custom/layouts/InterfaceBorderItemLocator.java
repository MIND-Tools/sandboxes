...
public class InterfaceBorderItemLocator
	...
	private int preferredSide = PositionConstants.EAST;

	private int currentSide = PositionConstants.EAST;
	...
	private Point setInterfacePosition(IFigure borderItem, IFigure interface_, Point wantedPosition){
		...
		if(returnPosition.y + verticalStep > parentY + parentFigureHeight){
			returnPosition.y = parentY + verticalStep;
