...
/**
 * This is the item provider adapter for a {@link mindide.MindRootSrc} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MindRootSrcItemProvider
	 ...
	 * @generated
	 */
	public MindRootSrcItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MindRootSrc"));
	}
	...
	public String getText(Object object) {
		String label = ((MindRootSrc)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MindRootSrc_type") :
			getString("_UI_MindRootSrc_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MindRootSrc.class)) {
