...
public class AdlStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new org.ow2.mind.AdlRuntimeModule());
	}
	
	public void register(Injector injector) {
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.ow2.org/mind/Adl")) {
		EPackage.Registry.INSTANCE.put("http://www.ow2.org/mind/Adl", org.ow2.mind.adl.AdlPackage.eINSTANCE);
	}
