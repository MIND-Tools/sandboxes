...
adlFile :
  a1=annotations importAnnotation* architectureDefinition
    -> ^(ADL annotations? importAnnotation* architectureDefinition);

importAnnotation :
  importDirective annotations;
...
subComponentDefinition :
  CONTAINS^ compositeDefinitionReference? AS! ID annonymousDefinition?;
