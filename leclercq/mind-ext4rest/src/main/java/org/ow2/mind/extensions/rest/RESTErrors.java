...
public enum RESTErrors implements ErrorTemplate {
  
  NO_SUCH_INTERFACE(0, "the component has no interface called \"%s\".", "<itf name>");
  
  /** The groupId of ErrorTemplates defined in this enumeration. */
  public static final String GROUP_ID = "REST";

  private int                id;
  private String             format;

  private RESTErrors(final int id, final String format, final Object... args) {
    this.id = id;
    this.format = format;
