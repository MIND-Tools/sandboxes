...
/**
 * This is the item provider adapter for a {@link adl.CompositeAnonymousSubComponent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CompositeAnonymousSubComponentItemProvider
	extends CompositeComponentDefinitionItemProvider
	implements
	 ...
	 * @generated
	 */
	public CompositeAnonymousSubComponentItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AdlPackage.Literals.COMPOSITE_ANONYMOUS_SUB_COMPONENT__REFERENCE_DEFINITION);
		}
	...
	/**
	 * This returns CompositeAnonymousSubComponent.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/CompositeAnonymousSubComponent"));
	}
	...
	public String getText(Object object) {
		String label = ((CompositeAnonymousSubComponent)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_CompositeAnonymousSubComponent_type") :
			getString("_UI_CompositeAnonymousSubComponent_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(CompositeAnonymousSubComponent.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AdlPackage.Literals.COMPOSITE_ANONYMOUS_SUB_COMPONENT__REFERENCE_DEFINITION,
				 AdlFactory.eINSTANCE.createCompositeReferenceDefinition()));
	}
