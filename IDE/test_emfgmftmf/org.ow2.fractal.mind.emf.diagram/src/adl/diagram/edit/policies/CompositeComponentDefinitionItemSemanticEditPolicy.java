...
import adl.diagram.edit.commands.CompositeReferencesListCreateCommand;
 ...
 * @generated
 */
public class CompositeComponentDefinitionItemSemanticEditPolicy extends
		MindBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public CompositeComponentDefinitionItemSemanticEditPolicy() {
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		...
		if (MindElementTypes.FormalArgumentsList_3003 == req.getElementType()) {
			return getGEFWrapper(new FormalArgumentsListCreateCommand(req));
		}
		if (MindElementTypes.CompositeReferencesList_3033 == req
				.getElementType()) {
			return getGEFWrapper(new CompositeReferencesListCreateCommand(req));
		}
