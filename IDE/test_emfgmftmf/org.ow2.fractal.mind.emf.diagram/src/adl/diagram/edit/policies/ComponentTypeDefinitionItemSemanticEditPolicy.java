...
import adl.diagram.edit.commands.TypeReferencesListCreateCommand;
 ...
 * @generated
 */
public class ComponentTypeDefinitionItemSemanticEditPolicy extends
		MindBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public ComponentTypeDefinitionItemSemanticEditPolicy() {
		super(MindElementTypes.ComponentTypeDefinition_2003);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		...
		if (MindElementTypes.TypeReferencesList_3037 == req.getElementType()) {
			return getGEFWrapper(new TypeReferencesListCreateCommand(req));
		}
