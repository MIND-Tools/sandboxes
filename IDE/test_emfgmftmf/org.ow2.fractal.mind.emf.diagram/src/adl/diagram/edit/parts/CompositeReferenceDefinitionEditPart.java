 ...
 * @generated
 */
public class CompositeReferenceDefinitionEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public CompositeReferenceDefinitionEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new CompositeReferenceDefinitionItemSemanticEditPolicy());
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof CompositeReferenceDefinitionCompartmentComponentReferenceDefinitionAreaEditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.remove(((CompositeReferenceDefinitionCompartmentComponentReferenceDefinitionAreaEditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof CompositeReferenceDefinitionCompartmentComponentReferenceDefinitionAreaEditPart) {
