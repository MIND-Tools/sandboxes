...
import adl.diagram.edit.policies.TypeReferenceDefinitionItemSemanticEditPolicy;
import adl.diagram.part.MindVisualIDRegistry;

/**
 * @generated
 */
public class TypeReferenceDefinitionEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public TypeReferenceDefinitionEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new TypeReferenceDefinitionItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof TypeReferenceDefinitionReferenceNameEditPart) {
			((TypeReferenceDefinitionReferenceNameEditPart) childEditPart)
