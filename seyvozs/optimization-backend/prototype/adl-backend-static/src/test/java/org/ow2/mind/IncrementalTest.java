...
public class IncrementalTest extends AbstractIncrementalTest {
  ...
  public void incrementalTest21() throws Exception {
    ...
    // SSZ : BEGIN MODIFICATION : Added this condition
    // Note : the inner simple assertUnchanged removes the file from the timestamps map
    // This is also why the previous "assertUnchangedAll ... .*Client_instances.c" is ok AND
    // the following "assertChangedAll ... .*Client.*" seeming contradictory BOTH work.
    assertUnchangedAll("helloworld/HelloworldApplication.*Client.optimized_macro",
            t1Copy, t2Copy);
  ...
  public void incrementalTest5() throws Exception {
    ...
    // This is also why the previous "assertUnchangedAll ... .*Client_instances.c" is ok AND
    // the following "assertChangedAll ... .*Client.*" seeming contradictory BOTH work.
    assertUnchangedAll("GenericApplication.*Client_modified.optimized_macro",
            t1Copy, t2Copy);
    // SSZ : END MODIFICATION
  ...
  public void incrementalTest51() throws Exception {
    ...
    // This is also why the previous "assertUnchangedAll ... .*Client_instances.c" is ok AND
    // the following "assertChangedAll ... .*Client.*" seeming contradictory BOTH work.
    assertUnchangedAll("GenericApplication.*ClientInlined_modified.optimized_macro",
            t1Copy, t2Copy);
    // SSZ : END MODIFICATION
  ...
  public void incrementalTest6() throws Exception {
    ...
    // This is also why the previous "assertUnchangedAll ... .*Client_instances.c" is ok AND
    // the following "assertChangedAll ... .*Client.*" seeming contradictory BOTH work.
    assertUnchangedAll("GenericApplication.*HelloworldAnonymous_modified_anon_0.optimized_macro",
            t1Copy, t2Copy);
    // SSZ : END MODIFICATION
