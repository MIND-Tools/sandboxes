...
public class FractalItfActivator extends AbstractUIPlugin {
	...
	public static final String ORG_OW2_MINDED_ITF_EDITOR_TEXTUAL_FRACTALITF = "org.ow2.mindEd.itf.editor.textual.FractalItf";
	
	private static final Logger logger = Logger.getLogger(FractalItfActivator.class);
	...
	protected Module getRuntimeModule(String grammar) {
		if (ORG_OW2_MINDED_ITF_EDITOR_TEXTUAL_FRACTALITF.equals(grammar)) {
