 ...
 * @generated
 */
public class CompositeReferencesListEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public CompositeReferencesListEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new CompositeReferencesListItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CompositeReferencesListCompartmentReferencesListAreaEditPart) {
			IFigure pane = getPrimaryShape().getFigureReferencesArea();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.add(((CompositeReferencesListCompartmentReferencesListAreaEditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CompositeReferencesListCompartmentReferencesListAreaEditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.remove(((CompositeReferencesListCompartmentReferencesListAreaEditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
