 ...
 * @generated
 */
public class CompositeReferenceDefinition2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public CompositeReferenceDefinition2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new CompositeReferenceDefinition2ItemSemanticEditPolicy());
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof CompositeReferenceDefinitionCompartmentReferenceDefinitionAreaEditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.remove(((CompositeReferenceDefinitionCompartmentReferenceDefinitionAreaEditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof CompositeReferenceDefinitionCompartmentReferenceDefinitionAreaEditPart) {
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == MindElementTypes.ArgumentDefinition_3026) {
				return getChildBySemanticHint(MindVisualIDRegistry
						.getType(CompositeReferenceDefinitionCompartmentReferenceDefinitionAreaEditPart.VISUAL_ID));
			}
			if (type == MindElementTypes.TemplateDefinition_3027) {
				return getChildBySemanticHint(MindVisualIDRegistry
						.getType(CompositeReferenceDefinitionCompartmentReferenceDefinitionAreaEditPart.VISUAL_ID));
			}
		}
