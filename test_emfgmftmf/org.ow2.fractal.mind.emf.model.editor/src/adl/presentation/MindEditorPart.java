...
public abstract class MindEditorPart extends EditorPart implements IMenuListener, IEditingDomainProvider {

	  protected AdlEditor parentEditor;
	  
	  public MindEditorPart(AdlEditor parent) {
	    super();
